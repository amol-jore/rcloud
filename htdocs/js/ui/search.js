                            ...
                            if(ks.length > 0 && d[i].parts[k].content !== "") {
                                ...
                                for(var l = 0; l < content.length; l++) {
                                    if (d[i].parts[k].filename === "comments") {
                                        try {
                                            var comment_content = content[l].substr(comment_content.indexOf("|||")+3, content[l].lastIndexOf("|||")-content[l].indexOf("|||")-3);
                                            var comment_author = "";
                                            if(content[l].length - content[l].lastIndexOf("|||") != 3){
                                                comment_author = content[l].substr(content[l].lastIndexOf("|||")+3, content[l].length-content[l].lastIndexOf("|||")-3);
                                            }
                                        }
                                        catch(e) {
                                            comment_content = content[l];
                                        }
